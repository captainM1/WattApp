...
export class DashboardComponent {
  ...
  chartOptions4 = {
	  ...
	  data: [{
		...
		markerSize: 0,            
		dataPoints: [
		  {x:new Date(2013,0,1,0,0), y: 67},
		  {x:new Date(2013,0,1,1,0), y: 58},
		  {x:new Date(2013,0,1,2,0), y: 65},
		  {x:new Date(2013,0,1,3,0), y: 87, indexLabel: "high",markerColor: "red", markerType: "triangle"},
		  {x:new Date(2013,0,1,4,0), y: 64},
		  {x:new Date(2013,0,1,5,0), y: 54},
		  {x:new Date(2013,0,1,6,0), y: 72},
		  {x:new Date(2013,0,1,7,0), y: 84, indexLabel: "high",markerColor: "red", markerType: "triangle"},
		  {x:new Date(2013,0,1,8,0), y: 66},
		  {x:new Date(2013,0,1,9,0), y: 80},
		  {x:new Date(2013,0,1,10,0), y: 47},
		  {x:new Date(2013,0,1,11,0), y: 49},         
		  {x:new Date(2013,0,1,12,0), y: 64, label: "noon" },                
		  {x:new Date(2013,0,1,13,0), y: 48},
		  {x:new Date(2013,0,1,14,0), y: 33},
		  {x:new Date(2013,0,1,15,0), y: 31},
		  {x:new Date(2013,0,1,16,0), y: 54},
		  {x:new Date(2013,0,1,17,0), y: 69},
		  {x:new Date(2013,0,1,18,0), y: 34},
		  {x:new Date(2013,0,1,19,0), y: 32},
		  {x:new Date(2013,0,1,20,0), y: 50},
		  {x:new Date(2013,0,1,21,0), y: 65},
		  {x:new Date(2013,0,1,22,0), y: 53},
		  {x:new Date(2013,0,1,23,0), y: 41} 
		]
	  }, {
		type: "area",
