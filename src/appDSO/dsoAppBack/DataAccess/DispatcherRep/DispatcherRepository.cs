...
{
    private readonly DataAccess.DataContext.DataContext _dbContext;
    private readonly IPasswordHasher _passwordHasher;
    private readonly ITokenMaker _tokenMaker;

    public DispatcherRepository(DataAccess.DataContext.DataContext dbContext, IPasswordHasher passwordHasher, ITokenMaker tokenMaker)
    {
